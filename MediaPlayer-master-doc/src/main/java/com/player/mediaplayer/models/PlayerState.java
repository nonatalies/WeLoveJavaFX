...
/**
 * Class PlayerState for saving the player state and serializing it.
 */
public class PlayerState implements Serializable {
    /**
     * A special class for storing a reduced amount of track information.
    ...
    /**
     * Creates an instance of the PlayerState class.
     * @param  player
     */
    ...
    /**
     * Initializes the player from the loaded state.
     * @param  player
     */
