...
/**
 * Class ContentPaneController responsible for the part of the GUI that contains the track list.
 */
public class ContentPaneController implements Initializable {
    ...
    /**
     * Configures the properties of table columns. Disables sorting and reordering.
     */
    ...
    /**
     * Sets the action to be performed when displaying "only liked" tracks.
     */
    ...
    /**
     * Sets the listener for playlist changes.
     * Allows you to display the current track list after any playlist changes.
     */
    ...
    /**
     * Adds a listener who automatically selects the desired track in the UI when changing the current track in the player.
     */
     ...
     * @param track
     * @throws for com.mpatric.mp3agic.InvalidDataException
     * @throws for InvalidDataException, UnsupportedTagException, IOException
     */
    ...
    /**
     * Processing of the "click on a table element" event.
     * Specifies the actions to be performed with the player when selecting a track in the table.
     */
    ...
    /**
     * Implementation of track search.
     */
    ...
    /**
     * Adding the "like" button to the table.
     */
